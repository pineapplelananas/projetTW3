...
-- Dumping structure for table db_twmprojets.ancien_etudiant
...
CREATE TABLE IF NOT EXISTS `ancien_etudiant` (
  ...
  CONSTRAINT `FK_ancien_etudiant_id_cursus` FOREIGN KEY (`fk_id_cursus_etud`) REFERENCES `cursus` (`id_cursus`),
  CONSTRAINT `FK_ancien_etudiant_id_moyenne` FOREIGN KEY (`fk_id_moyenne_l3_etud`) REFERENCES `moyenne_l3` (`id_moyenne`),
  CONSTRAINT `FK_ancien_etudiant_id_specialite` FOREIGN KEY (`fk_id_specialite_etud`) REFERENCES `specialite` (`id_specialite`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=latin1;

-- Dumping data for table db_twmprojets.ancien_etudiant: ~58 rows (approximately)
 ALTER TABLE `ancien_etudiant` DISABLE KEYS;
INSERT INTO `ancien_etudiant` (`id_etud`, `nom_etud`, `prenom_etud`, `mail_etud`, `promotion_etud`, `fk_id_specialite_etud`, `fk_id_cursus_etud`, `fk_id_moyenne_l3_etud`) VALUES
 ...
 ALTER TABLE `ancien_etudiant` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.a_effectue
...
CREATE TABLE IF NOT EXISTS `a_effectue` (
  ...
  CONSTRAINT `FK_a_effectue_id_statut` FOREIGN KEY (`fk_statut_id`) REFERENCES `statut` (`id_statut`),
  CONSTRAINT `FK_a_effectue_id_etud` FOREIGN KEY (`fk_id_etud`) REFERENCES `ancien_etudiant` (`id_etud`),
  CONSTRAINT `FK_a_effectue_id_formation` FOREIGN KEY (`fk_id_formation`) REFERENCES `formation` (`id_formation`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table db_twmprojets.a_effectue: ~50 rows (approximately)
 ALTER TABLE `a_effectue` DISABLE KEYS ;
INSERT INTO `a_effectue` (`debut_formation`, `fk_id_formation`, `fk_id_etud`, `fk_statut_id`) VALUES
	...
	('2006', 29, 52, 3),
	('2006', 30, 53, 3);
 ALTER TABLE `a_effectue` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.cursus
...
-- Dumping data for table db_twmprojets.cursus: ~4 rows (approximately)
 ALTER TABLE `cursus` DISABLE KEYS ;
INSERT INTO `cursus` (`id_cursus`, `lib_cursus`) VALUES
	...
	(3, 'Autre cursus');
 ALTER TABLE `cursus` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.entreprise
...
CREATE TABLE IF NOT EXISTS `entreprise` (
  ...
  CONSTRAINT `FK_entreprise_id_region` FOREIGN KEY (`fk_id_region_ese`) REFERENCES `region` (`id_region`)
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=latin1;

-- Dumping data for table db_twmprojets.entreprise: ~52 rows (approximately)
 ALTER TABLE `entreprise` DISABLE KEYS ;
INSERT INTO `entreprise` (`id_entreprise`, `nom_ese`, `adresse_ese`, `secteur_activite_ese`, `ville_ese`, `code_postal_ese`, `pays_ese`, `fk_id_region_ese`) VALUES
	...
	(99, 'ND', '0', '', '', '0', '', 'NA');
 ALTER TABLE `entreprise` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.etablissement
...
CREATE TABLE IF NOT EXISTS `etablissement` (
  ...
  CONSTRAINT `FK_etablissement_id_region` FOREIGN KEY (`fk_id_region_etab`) REFERENCES `region` (`id_region`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=latin1;

-- Dumping data for table db_twmprojets.etablissement: ~18 rows (approximately)
 ALTER TABLE `etablissement` DISABLE KEYS ;
INSERT INTO `etablissement` (`id_etablissement`, `nom_etab`, `sigle_etab`, `code_postal_etab`, `ville_etab`, `pays_etab`, `fk_id_region_etab`) VALUES
	(1, 'Université Paul Sabatier - Toulouse 3', 'UPS', '31000', 'Toulouse', 'France', 'FR-OCC'),
	(2, 'Institut National Universitaire de Champollion', 'INUC', '81000', 'Albi', 'France', 'FR-OCC'),
	(3, 'Université Marie et Pierre Curie Paris VI', 'UMPC', '75000', 'Paris', 'France', 'FR-IDF'),
	(4, 'Montpellier 2', '', '34000', 'Montpellier', 'France', 'FR-OCC'),
	(5, 'Paul Valery – Montpellier  3', '', '34000', 'Montpellier', 'France', 'FR-OCC'),
	(6, 'Université Claude Bernard Lyon 1', '', '69000', 'Lyon', 'France', 'FR-ARA'),
	(7, 'Pole Universitaire de Vichy', '', '03200', 'Vichy', 'France', 'FR-ARA'),
	(8, 'Telecom Paristech', '', '75000', 'Paris', 'France', 'FR-IDF'),
	(9, 'Université Paris Sud', '', '75000', 'Paris', 'France', 'FR-IDF'),
	(10, 'Université Denis Diderot Paris', '', '75000', 'Paris', 'France', 'FR-IDF'),
	(11, 'Université d Aix-Marseille', '', '13007', 'Marseille', 'France', 'FR-PAC'),
	(12, 'Ecole d ingénieur 3IL', '3IL', '87000', 'Limoges', 'France', 'FR-NAQ'),
	(13, 'Arts et Métiers ParisTech Angers - site de Laval', '', '53000', 'Laval', 'France', 'FR-PDL'),
	(14, 'Rennes 1', '', '35000', 'Rennes', 'France', 'FR-BRE'),
	(15, 'ISIS', 'ISIS', '81100', 'Castres', 'France', 'FR-OCC'),
	(16, 'Polytech Orléans', '', '45072', 'Orléans', 'France', 'FR-PDL'),
	(17, 'IUT de Rodez', '', '12000', 'Rodez', 'France', 'FR-OCC'),
	(18, 'Faculté des Sciences et techniques', 'Limoges-FST', '87000', 'Limoges', 'France', 'FR-NAQ');
 ALTER TABLE `etablissement` ENABLE KEYS ;

-- Dumping structure for table db_twmprojets.formation
...
CREATE TABLE IF NOT EXISTS `formation` (
  ...
  CONSTRAINT `FK_formation_id_etablissement` FOREIGN KEY (`fk_id_etablissement_form`) REFERENCES `etablissement` (`id_etablissement`),
  CONSTRAINT `FK_fomation_id_specialite` FOREIGN KEY (`fk_id_specialite_form`) REFERENCES `specialite` (`id_specialite`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=latin1;

-- Dumping data for table db_twmprojets.formation: ~31 rows (approximately)
 ALTER TABLE `formation` DISABLE KEYS ;
INSERT INTO `formation` (`id_formation`, `intitule_form`, `sigle_form`, `type_form`, `fk_id_specialite_form`, `fk_id_etablissement_form`) VALUES
 ...
 ALTER TABLE `formation` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.moyenne_l3
...
-- Dumping data for table db_twmprojets.moyenne_l3: ~4 rows (approximately)
 ALTER TABLE `moyenne_l3` DISABLE KEYS */;
INSERT INTO `moyenne_l3` (`id_moyenne`, `mention`) VALUES
	(1, 'Passable'),
	(2, 'Assez bien'),
	(3, 'Bien'),
	(4, 'Très bien');
 ALTER TABLE `moyenne_l3` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.offre_emploi
...
-- Dumping data for table db_twmprojets.offre_emploi: ~0 rows (approximately)
 ALTER TABLE `offre_emploi` DISABLE KEYS ;
 ALTER TABLE `offre_emploi` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.offre_stage
...
-- Dumping data for table db_twmprojets.offre_stage: ~0 rows (approximately)
 ALTER TABLE `offre_stage` DISABLE KEYS ;
 ALTER TABLE `offre_stage` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.poste
...
CREATE TABLE IF NOT EXISTS `poste` (
  ...
  CONSTRAINT `FK_poste_id_entreprise` FOREIGN KEY (`fk_id_entreprise_poste`) REFERENCES `entreprise` (`id_entreprise`),
  CONSTRAINT `FK_poste_id_etud` FOREIGN KEY (`fk_id_etud_poste`) REFERENCES `ancien_etudiant` (`id_etud`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table db_twmprojets.poste: ~62 rows (approximately)
 ALTER TABLE `poste` DISABLE KEYS ;
INSERT INTO `poste` (`intitule_poste`, `debut_poste`, `fin_poste`, `description_poste`, `specialite_poste`, `fk_id_etud_poste`, `fk_id_entreprise_poste`) VALUES
 ...
 ALTER TABLE `poste` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.propose_emploi
...
CREATE TABLE IF NOT EXISTS `propose_emploi` (
  ...
  CONSTRAINT `FK_propose_emploi_id_emploi` FOREIGN KEY (`id_emploi`) REFERENCES `offre_emploi` (`id_emploi`),
  CONSTRAINT `FK_propose_emploi_id_entreprise` FOREIGN KEY (`id_entreprise`) REFERENCES `entreprise` (`id_entreprise`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table db_twmprojets.propose_emploi: ~0 rows (approximately)
 ALTER TABLE `propose_emploi` DISABLE KEYS ;
 ALTER TABLE `propose_emploi` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.propose_stage
...
CREATE TABLE IF NOT EXISTS `propose_stage` (
  ...
  CONSTRAINT `FK_propose_stage_id_entreprise` FOREIGN KEY (`id_entreprise`) REFERENCES `entreprise` (`id_entreprise`),
  CONSTRAINT `FK_propose_stage_id_stage` FOREIGN KEY (`id_stage`) REFERENCES `offre_stage` (`id_stage`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table db_twmprojets.propose_stage: ~0 rows (approximately)
 ALTER TABLE `propose_stage` DISABLE KEYS ;
 ALTER TABLE `propose_stage` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.region
...
-- Dumping data for table db_twmprojets.region: ~12 rows (approximately)
...
-- Dumping structure for table db_twmprojets.specialite
...
-- Dumping data for table db_twmprojets.specialite: ~2 rows (approximately)
 ALTER TABLE `specialite` DISABLE KEYS ;
INSERT INTO `specialite` (`id_specialite`, `lib_specialite`) VALUES
	(0, 'Non mentioné'),
	(1, 'Développement Logiciel');
 ALTER TABLE `specialite` ENABLE KEYS ;


-- Dumping structure for table db_twmprojets.statut
...
-- Dumping data for table db_twmprojets.statut: ~5 rows (approximately)
 ALTER TABLE `statut` DISABLE KEYS ;
INSERT INTO `statut` (`id_statut`, `lib_statut`) VALUES
	...
	(4, 'Obtenu en 2 ans'),
	(5, 'Abandonné');
 ALTER TABLE `statut` ENABLE KEYS ;
